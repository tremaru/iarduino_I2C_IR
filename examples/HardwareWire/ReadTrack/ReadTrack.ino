...
void setup(){                                       //
     ...
     ir.setProtocol(IR_IARDUINO);                   //   Указываем протокол для приёма/передачи данных по ИК-каналу. Доступные протоколы: IR_NEC, IR_SAMSUNG, IR_SHARP, IR_SIRC12, IR_SIRC15, IR_RC5, IR_RC5X, IR_RC6, IR_IARDUINO.
